<template>
	...
	<header class="top_bar">
	        ...
	        <form  class="goods_search" v-on:submit.prevent>
	        	<input type="saerch" class="goods_search_content" placeholder="搜索" v-model="keyword" @keyup.enter="goSearch(keyword)" @keyup="goSearch(keyword)">
	            <span @click="clearInp" class="clear-input">x</span>
	        </form>
	        <a href="#" class="search">
				<span>
					搜索
		...
		<main class="main_goods_box">
	        <ul>
	            <li class="goods_item" :key="item.product_id" v-for="item in mDatas">
